...
class MyGeminiConnection {
  static MyGeminiConnection? _connection;


  static MyGeminiConnection get instance {
    _connection ??= MyGeminiConnection._();
    return _connection!;
  }

  MyGeminiConnection._();
